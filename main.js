...
// Get the button
let jumpbutton = document.getElementById("myBtn");
...
(function() {
	...
	let _depth5 = `${50 - (_mouseX - _w) * 0.030}% ${50 - (_mouseY - _h) * 0.020}%`;
	let _depth6 = `${50 - (_mouseX - _w) * 0.018}% ${50 - (_mouseY - _h) * 0.009}%`;
	let _depth7 = `${50 - (_mouseX - _w) * 0.019}% ${50 - (_mouseY - _h) * 0.013}%`;
	let _depth8 = `${50 - (_mouseX - _w) * 0.020}% ${50 - (_mouseY - _h) * 0.015}%`;
	let _depth9 = `${50 - (_mouseX - _w) * 0.028}% ${50 - (_mouseY - _h) * 0.027}%`;
