...
(function() {
	...
	let _depth4 = `${50 - (_mouseX - _w) * 0.012}% ${50 - (_mouseY - _h) * 0.005}%`;
	...
	let _depth9 = `${50 - (_mouseX - _w) * 0.024}% ${50 - (_mouseY - _h) * 0.017}%`;
	let _depth10 = `${50 - (_mouseX - _w) * 0.026}% ${50 - (_mouseY - _h) * 0.019}%`;
